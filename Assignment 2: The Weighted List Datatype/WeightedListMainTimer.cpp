...
//	}
	...
	e = wList.begin();
	++e;
    asg::WeightedList<int>::iterator f = e;
	++f;
	++f;
	...
	asg::WeightedList<int> wList2(wList);
	wList2.search(19);
	...
	asg::WeightedList<int> wList3 = wList;
	wList3.search(18);
    ...
    asg::WeightedList<int> wList4(std::move(wList3));
    ...
    asg::WeightedList<int> wList5 = std::move(wList2);
